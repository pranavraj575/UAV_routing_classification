...
function testing_gradient_descent(beta1, beta2, taui_arr = [], alpha = NaN,
    figure_name = "test.pdf")
    # beta1 is 0.2, beta2 is 0.5.
...
function old_dwell_time_info_gain_func_two_dwell_times(d1, d2, tau1, tau2, alpha)
    ...
    P1 = 1 - 0.5*exp(-d1/tau1)
    P2 = 1 - 0.5*exp(-d2/tau2)
